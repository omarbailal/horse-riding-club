...
public class CalenderViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
    ...
    private final CalenderMonthAdapter.OnItemLitener onItemLitener;
    public Seance seance;

    public CalenderViewHolder(@NonNull View itemView, CalenderMonthAdapter.OnItemLitener onItemLitener) {
        super(itemView);
