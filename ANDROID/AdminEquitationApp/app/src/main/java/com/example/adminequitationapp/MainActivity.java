...
public class MainActivity extends AppCompatActivity implements CalendarAdapter.OnItemListener{
    ...
    private void setTasks(){
        ...
        if(tasksInWeek != null)
            tasksList.setAdapter(new TaskAdapter(MainActivity.this, tasksInWeek,1));
    }
    @RequiresApi(api = Build.VERSION_CODES.O)
...
//            }
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, "http://" + login.ipAddress + "/equitationApp/public/api/client/",
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        seancesList.setAdapter(new SeanceAdapter(MainActivity.this, seances, clients,1));
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
    ...
    public void onItemclick(int position, String dayText) {
        ...
        if(tasksInDay != null){
            tasksList.setAdapter(new TaskAdapter(MainActivity.this, tasksInDay, 1));
        }
